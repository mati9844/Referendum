        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    Input.NewEmail,
                    "Potwierdź email",
                    $"Potwierdź adres email <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>kliknij tutaj/a>.");

                StatusMessage = "Potwierdzenie zostało wysłane. Prosimy sprawdzić pocztę.";
